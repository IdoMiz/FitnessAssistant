...
public class FirebaseInstance {
    ...
    private FirebaseInstance(Context context) {
        FirebaseOptions options = new
                ...
                .setProjectId("fitnessassistant-3bddc")		// ApplicationId
                .setApplicationId("fitnessassistant-3bddc")		// ProjectId
                .setApiKey("AIzaSyBbxxem6idnYTsLjutYd8Sab40wiSJz9Ww")
                .setStorageBucket("fitnessassistant-3bddc.appspot.com")
                .build();
